...
**➜ [clarasalas.github.io/strategic-voting-geo-2RS](https://clarasalas.github.io/strategic-voting-geo-2RS/)**
...
* **Département boundaries** for the maps, downloaded by hand into `data/raw/geography/departements-100m.geojson`
  (GeoJSON with a `code` property holding the département code; any CRS).
